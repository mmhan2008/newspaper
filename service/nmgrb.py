...
logger = Logger(logname= 'newspaper',logger='nmgrb').getlog()
            ...
            for link in a:
                ...
                if any(key in title for key in keys) or title == '':
                    ...
                    if resp1.status_code == 200:
                        ...
                        list.append('{}###{}###内蒙古日报###{}###{}'.format(realpath,title,nohtml_content,content))
                    time.sleep(random.randint(0,2))
    except Exception as e:
        logger.info('=========================内蒙古日报解析异常=========================')
        logger.info(tempurl)
        logger.info(e)
    finally:
        return list
